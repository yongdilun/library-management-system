...
Tester: Yong Di Lun
Execution: 2026-06-04T11:26:35 to 2026-06-04T11:27:19
Summary: Total 68, Pass 40, Fail 28, Not Executed 0
...
| REQ-F005 | TDS-2.3.5 | TC-05-004 | TP-05-002 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-005 | Simulated BookManager.list database failure returned HTTP 500. |
...
| REQ-F006 | TDS-2.3.6 | TC-06-005 | TP-06-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-006 | Simulated BookManager.getBook database failure returned HTTP 500. |
| REQ-F007 | TDS-2.3.7 | TC-07-001 | TP-07-001 | Functional Testing | Selenium | Pass | - | Search was executed with a valid keyword. |
| REQ-F007 | TDS-2.3.7 | TC-07-002 | TP-07-002 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-007 | Empty search input was submitted from the home search form. |
| REQ-F007 | TDS-2.3.7 | TC-07-003 | TP-07-003 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-008 | A 60-character keyword was submitted. |
...
| REQ-F007 | TDS-2.3.7 | TC-07-006 | TP-07-002 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-009 | Empty search validation message was checked. |
...
| REQ-F008 | TDS-2.3.8 | TC-08-003 | TP-08-003 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-010 | A user with five reservations attempted another reservation. |
| REQ-F008 | TDS-2.3.8 | TC-08-004 | TP-08-002 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-011 | Duplicate reservation route was invoked directly with an authenticated user session. |
| REQ-F008 | TDS-2.3.8 | TC-08-005 | TP-08-003 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-012 | Reservation limit message was checked after exceeding the limit. |
...
| REQ-F0010 | TDS-2.3.10 | TC-10-001 | TP-10-001 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-013 | Admin Add Book route was submitted with valid data. |
| REQ-F0010 | TDS-2.3.10 | TC-10-009 | TP-10-001 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-014 | Database insertion was checked after valid Add Book submission. |
...
| REQ-F0010 | TDS-2.3.10 | TC-10-003 | TP-10-002 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-015 | Description field was inspected for required validation. |
| REQ-F0010 | TDS-2.3.10 | TC-10-004 | TP-10-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-016 | Quantity field was inspected for a minimum value rule. |
...
| REQ-F0010 | TDS-2.3.10 | TC-10-006 | TP-10-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-017 | Duplicate book handling was checked against the real Add Book route/page. |
...
| REQ-F0010 | TDS-2.3.10 | TC-10-008 | TP-10-002 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-018 | Field-specific error message was checked for missing Description. |
...
| REQ-F0011 | TDS-2.3.11 | TC-11-002 | TP-11-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-019 | Simulated BookManager.delete failure returned HTTP 500; target book still exists = True. |
| REQ-F0011 | TDS-2.3.11 | TC-11-003 | TP-11-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-020 | Delete non-existing book returned HTTP 302. |
...
| REQ-F0011 | TDS-2.3.11 | TC-11-005 | TP-11-001 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-021 | Admin delete link was inspected for an explicit confirmation step. |
| REQ-F0011 | TDS-2.3.11 | TC-11-006 | TP-11-002 | Functional Testing | Selenium | Fail | LMS_TIR_1.0/TIR-022 | Cancel deletion flow was checked; no confirmation dialog is implemented. |
| REQ-F0011 | TDS-2.3.11 | TC-11-008 | TP-11-003 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-023 | Deletion failure message check used simulated delete failure response HTTP 500. |
| REQ-F0012 | TDS-2.3.12 | TC-12-001 | TP-12-001 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-024 | Admin edit route was submitted with valid values. |
| REQ-F0012 | TDS-2.3.12 | TC-12-010 | TP-12-001 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-025 | Database was checked after valid edit submission. |
| REQ-F0012 | TDS-2.3.12 | TC-12-002 | TP-12-002 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-026 | Invalid edit Book ID returned HTTP 200. |
...
| REQ-F0012 | TDS-2.3.12 | TC-12-005 | TP-12-004 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-027 | Quantity field was inspected for a positive/minimum value rule. |
...
| REQ-F0012 | TDS-2.3.12 | TC-12-007 | TP-12-001 | Functional Testing | Postman/HTTP | Fail | LMS_TIR_1.0/TIR-028 | Description-only edit was submitted through the edit route. |
